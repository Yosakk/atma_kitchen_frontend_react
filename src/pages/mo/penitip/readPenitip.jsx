...
const readPenitip = () => {
  ...
  const totalPages = Math.ceil(
    penitipTableData.length / itemsPerPage
  );
    ...
    <div className="mt-12 mb-8 flex flex-col gap-12">
      <Card>
        ...
        <div className="ml-auto mt-1 mb-4 mr-4 w-56 flex justify-end items-center">
          ...
          <table className="w-full min-w-[640px] table-auto">
            ...
            <tbody>
              {currentItems.map(({ nama, NoTelepon }, key) => {
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center">
          ...
          <Typography variant="h6" className="mb-4">Hapus Penitip</Typography>
            <Typography className="text-gray-600 mb-4">Apakah anda yakin ingin menghapus Penitip {selectedPenitip?.nama}?</Typography>
