...
export const showDataHampersByID = async (id) => {
    const token = sessionStorage.getItem("token");
    try {
        const response = await urlAxios.get(`/produk_hampers/${id}`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        });
...
export const editDataHampers = async (id, data) => {
    const token = sessionStorage.getItem("token");
    try {
        const response = await urlAxios.post(`/produk_hampers/${id}`, data, {
            headers: {
                Authorization: `Bearer ${token}`,
                "Content-Type": "multipart/form-data",
            },
