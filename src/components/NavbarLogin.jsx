...
import { faBell, faShoppingCart, faHouse, faBagShopping } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="flex items-center justify-between text-white">
        ...
        <div className="hidden gap-2 lg:flex">
          {isLoggedInUser ?
            (
              <Menu>
                <Typography variant="small" className="flex font-medium justify-center items-center">{userData?.username}</Typography>
                <MenuHandler>
                  <Avatar
                    variant="circular"
                    alt="tania andrew"
